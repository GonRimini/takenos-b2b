...
import { useMovementsFetcher } from "@/hooks/use-movement-fetcher"
...
export default function Dashboard() {
  ...
  // Nota: fetchMovementsData ahora viene del hook useMovementsFetcher que incluye la lógica de enriquecimiento
